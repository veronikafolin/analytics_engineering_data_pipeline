...
metadata_tables as (
    select
        ...
        ( COALESCE(new.row_count, 0) - COALESCE(old.row_count, 0) ) as row_count_delta,
        CURRENT_DATE() as partition_date
    from new_state_of_metadata as new left join previous_state_of_metadata as old on (new.TABLE_REF = old.TABLE_REF)
)
